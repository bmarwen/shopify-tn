...
-- CreateEnum
CREATE TYPE "PaymentMethodType" AS ENUM ('CASH', 'BANK_TRANSFER', 'REMITLY', 'CREDIT_CARD', 'PAYPAL', 'CHECK', 'OTHER');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'COMPLETED', 'FAILED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED', 'RETURNED');
...
CREATE TABLE "Order" (
    ...
    "cashAmountGiven" DOUBLE PRECISION,
    "cashAmountChange" DOUBLE PRECISION,
...
CREATE TABLE "OrderItem" (
    ...
    "productImage" TEXT,
    "productTva" DOUBLE PRECISION NOT NULL,
