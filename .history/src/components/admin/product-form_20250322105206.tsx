// src/components/admin/product-form.tsx (with improved colors)
"use client";
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Tabs defaultValue="basic" className="w-full">
          <TabsList className="mb-4 bg-indigo-100 p-1">
            <TabsTrigger
              className="data-[state=active]:bg-white data-[state=active]:text-indigo-700 text-indigo-600"
              value="basic"
            >
              Basic Info
            </TabsTrigger>
