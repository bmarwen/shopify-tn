  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        {/* Professional Tabs with clear active state */}
        <Tabs defaultValue="basic" className="w-full">
          <TabsList className="mb-4 bg-slate-50 p-0 rounded-md shadow-sm border border-slate-200">
            <TabsTrigger
              className="data-[state=active]:bg-white data-[state=active]:text-slate-900 data-[state=active]:shadow-sm data-[state=active]:border-b-2 data-[state=active]:border-blue-600 text-slate-600 px-4 py-2"
              value="basic"
            >
              Basic Info
            </TabsTrigger>
