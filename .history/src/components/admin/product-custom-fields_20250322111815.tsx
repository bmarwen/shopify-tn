      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Tabs defaultValue="basic" className="w-full">
          <TabsList className="mb-6 bg-gray-100 p-1 rounded-lg">
            <TabsTrigger className="tab-button rounded-md" value="basic">
              Basic Info
            </TabsTrigger>
            <TabsTrigger className="tab-button rounded-md" value="images">
              Images
            </TabsTrigger>
            <TabsTrigger className="tab-button rounded-md" value="pricing">
              Pricing & Inventory
            </TabsTrigger>
            <TabsTrigger className="tab-button rounded-md" value="categories">
              Categories
            </TabsTrigger>
            <TabsTrigger className="tab-button rounded-md" value="variants">
              Variants
            </TabsTrigger>
            <TabsTrigger
              className="tab-button rounded-md"
              value="custom-fields"
            >
              Custom Fields
            </TabsTrigger>
          ...
          <TabsContent value="basic" className="space-y-4">
            <Card className="border-0 shadow">
              <CardHeader className="card-header rounded-t-lg">
                ...
                <CardDescription className="card-description mt-1 text-base">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className="border-2 border-bdc3c7"
                          {...field}
                        />
                      </FormControl>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          ...
                          className="min-h-[150px] border-2 border-bdc3c7"
                          {...field}
                        />
                      </FormControl>
                      <FormMessage className="text-red-600" />
