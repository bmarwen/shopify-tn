...
export default function DiscountForm({
  ...
  const defaultValues: DiscountFormValues = discount
    ...
    : {
        ...
        ).toISOString().split("T")[0], // Default to 30 days from now
      };
          ...
          <div className="space-y-6">
              ...
              <Card className="border border-gray-200 shadow-sm">
                ...
                <CardContent className="pt-6 bg-white">
                  <div className="space-y-4">
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-gray-500">Original Price</h3>
                    ...
                    <div>
                      ...
                      <p className="text-lg font-medium text-orange-600">{percentage}%</p>
                    </div>
                    <div>
                      <h3 className="text-sm font-medium text-gray-500">Discounted Price</h3>
                      <p className="text-xl font-bold text-green-600">
                        ${getDiscountedPrice(selectedProduct.price, percentage).toFixed(2)}
                      </p>
                    </div>
                    <div>
            ...
            <Card className="border border-blue-200 shadow-sm">
              <CardHeader className="bg-blue-50 border-b border-blue-200">
                <CardTitle className="text-lg text-blue-800">About Discounts</CardTitle>
              </CardHeader>
