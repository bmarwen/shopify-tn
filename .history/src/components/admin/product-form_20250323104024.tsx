...
export default function ProductForm({
  ...
  const handleTabChange = (value: string) => {
    ...
    // Merge with existing formData to avoid losing any data
    setFormData((prevData: any) => ({
      ...(prevData || {}),
      ...currentValues,
    }));

    // Update active tab after state is preserved
    setActiveTab(value);

    // Trigger a re-render with a slight delay to ensure all data is loaded
    setTimeout(() => {
                      ...
                      <FormControl>
                        <ProductImagesUpload
                          ...
                          onImagesChange={(images) => {
                            ...
                            // Ensure the form knows about this change
