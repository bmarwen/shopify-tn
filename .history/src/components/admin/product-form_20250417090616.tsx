...
import DiscountsTab from "./product-tabs/discounts-tab";
import DiscountCodesTab from "./product-tabs/discount-codes-tab";
        ...
        >
          <TabsList className="mb-6 bg-gray-100 p-1 rounded-lg">
            ...
            <TabsTrigger
              ...
              style={{
                backgroundColor:
                  activeTab === "discounts" ? "#2c3e50" : "transparent",
                color: activeTab === "discounts" ? "white" : "#bdc3c7",
              }}
              value="discounts"
            >
              Discounts
            ...
            <TabsTrigger
              ...
              style={{
                backgroundColor:
                  activeTab === "discount-codes" ? "#2c3e50" : "transparent",
                color: activeTab === "discount-codes" ? "white" : "#bdc3c7",
              }}
            ...
            {isEditing && product?.id ? (
              ...
              <div className="bg-yellow-50 p-6 rounded-lg text-center border border-yellow-200">
                <p className="text-yellow-800">
                  You need to save the product first before adding discounts.
                </p>
              </div>
            )}
          </TabsContent>
